...
当前发布包适用于 64 位 Windows，并需要 [.NET 8 Desktop Runtime](https://dotnet.microsoft.com/download/dotnet/8.0)。程序尚未进行代码签名。
...
- 广播本身没有可稳定映射到 Windows 配对记录的公开身份，同型号 AirPods 在非常近的范围内可能触发一次检查；
